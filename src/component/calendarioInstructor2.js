...
export default function CalendarioSemanal() {
  ...
  const irAPaginaAnteriorCalendario = () => {
    ...
    <div className="contenedor-principal">
      ...
      <div className="secciones">
        ...
        <div className="seccion-central">
          ...
          />
          <button className="boton-flecha boton-adelanteInstructor">➡</button>
          <button
            className="boton-flecha boton-atrasInstructor"
            onClick={irAPaginaAnteriorCalendario}
          >
            ⬅
          </button>
          <h1 className="titulo-calendario">Bienvenido</h1>
          <p className="numero-ficha">Horario del 7 octubre al 11</p>
